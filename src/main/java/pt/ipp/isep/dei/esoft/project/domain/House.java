...
public class House implements Property, Location, Serializable {
    ...
    /**
     * Shows if the loft is Habitable
     */
     ...
     * @param numberBedrooms Number of bedrooms that exist in the House
     * @param numberParking  Number of parking spaces availabale
     */
    public House(PropertyType propertyType, double area, double distance, List<String> photographs, String street,
     ...
     * @param loft           Existance of a habitable loft
     */
    public House(PropertyType propertyType, double area, double distance, List<String> photographs, String street,
            String zip, String state, String city, String district, int numberBedrooms, int numberParking,
            boolean basement, boolean loft) throws IllegalArgumentException {
        validatePropertyArguments(propertyType, area, distance, photographs);
        validateLocation(zip, street, state, city, district);
        if (numberBedrooms < 0 || numberParking < 0)
            throw new IllegalArgumentException("Incorrect arguments (bedroom or parking), please try again.");
     ...
     * @param numberBedrooms Number of bedrooms that exist in the House
     * @param numberParking  Number of parking spaces availabale
     * @param sunExposure    direction from which the sun hits the house
     */
    public House(PropertyType propertyType, double area, double distance, List<String> photographs, String street,
            String zip, String state, String city, String district, int numberBedrooms, int numberParking,
            SunExposure sunExposure) throws IllegalArgumentException {
        validatePropertyArguments(propertyType, area, distance, photographs);
        validateLocation(zip, street, state, city, district);
        validSunExposure(sunExposure);
        if (numberBedrooms < 0 || numberParking < 0)
            throw new IllegalArgumentException("Incorrect arguments (bedroom or parking), please try again.");
        this.propertyType = propertyType;
        this.area = area;
    ...
    public House(PropertyType propertyType, double area, double distance, List<String> photographs, String street,
            String zip, String state, String city, String district, int numberBedrooms, int numberParking,
            boolean basement, boolean loft, SunExposure sunExposure) throws IllegalArgumentException {
        validatePropertyArguments(propertyType, area, distance, photographs);
        validateLocation(zip, street, state, city, district);
        validSunExposure(sunExposure);
        if (numberBedrooms < 0 || numberParking < 0)
    ...
    public House(PropertyType propertyType, double area, double distance, List<String> photographs, String street,
            String zip, String state, String city, String district, int numberBedrooms, int numberParking,
            int numberBathrooms, boolean basement, boolean loft) throws IllegalArgumentException {
        validatePropertyArguments(propertyType, area, distance, photographs);
        validateLocation(zip, street, state, city, district);
        if (numberBedrooms < 0 || numberParking < 0 || numberBathrooms < 0)
            throw new IllegalArgumentException(
    ...
    public House(PropertyType propertyType, double area, double distance, List<String> photographs, String street,
            String zip, String state, String city, String district, int numberBedrooms, int numberParking,
            int numberBathrooms, SunExposure sunExposure) throws IllegalArgumentException {
        validatePropertyArguments(propertyType, area, distance, photographs);
        validateLocation(zip, street, state, city, district);
        validSunExposure(sunExposure);
        if (numberBedrooms < 0 || numberParking < 0 || numberBathrooms < 0)
    ...
    public House(PropertyType propertyType, double area, double distance, List<String> photographs, String street,
            String zip, String state, String city, String district, int numberBedrooms, int numberParking,
            int numberBathrooms, boolean basement, boolean loft, SunExposure sunExposure)
            throws IllegalArgumentException {
        validatePropertyArguments(propertyType, area, distance, photographs);
        validateLocation(zip, street, state, city, district);
        validSunExposure(sunExposure);
    ...
    public House(PropertyType propertyType, double area, double distance, List<String> photographs, String street,
            String zip, String state, String city, String district, int numberBedrooms, int numberParking,
            String availableEquipment, boolean basement, boolean loft) throws IllegalArgumentException {
        validatePropertyArguments(propertyType, area, distance, photographs);
        validateLocation(zip, street, state, city, district);
        if (numberBedrooms < 0 || numberParking < 0)
            throw new IllegalArgumentException("Incorrect arguments (bedroom or parking), please try again.");
    ...
    public House(PropertyType propertyType, double area, double distance, List<String> photographs, String street,
            String zip, String state, String city, String district, int numberBedrooms, int numberParking,
            String availableEquipment, SunExposure sunExposure) throws IllegalArgumentException {
        validatePropertyArguments(propertyType, area, distance, photographs);
        validateLocation(zip, street, state, city, district);
        validSunExposure(sunExposure);
        if (numberBedrooms < 0 || numberParking < 0)
    ...
    public House(PropertyType propertyType, double area, double distance, List<String> photographs, String street,
            String zip, String state, String city, String district, int numberBedrooms, int numberParking,
            String availableEquipment, boolean basement, boolean loft, SunExposure sunExposure)
            throws IllegalArgumentException {
        validatePropertyArguments(propertyType, area, distance, photographs);
        validateLocation(zip, street, state, city, district);
        validSunExposure(sunExposure);
    ...
    public House(PropertyType propertyType, double area, double distance, List<String> photographs, String street,
            String zip, String state, String city, String district, int numberBedrooms, int numberParking,
            int numberBathrooms, String availableEquipment, boolean basement, boolean loft)
            throws IllegalArgumentException {
        validatePropertyArguments(propertyType, area, distance, photographs);
        validateLocation(zip, street, state, city, district);
        if (numberBedrooms < 0 || numberParking < 0 || numberBathrooms < 0)
    ...
    public House(PropertyType propertyType, double area, double distance, List<String> photographs, String street,
            String zip, String state, String city, String district, int numberBedrooms, int numberParking,
            int numberBathrooms, String availableEquipment, SunExposure sunExposure) throws IllegalArgumentException {
        validatePropertyArguments(propertyType, area, distance, photographs);
        validateLocation(zip, street, state, city, district);
        if (numberBedrooms < 0 || numberParking < 0 || numberBathrooms < 0)
            throw new IllegalArgumentException(
    ...
    public House(PropertyType propertyType, double area, double distance, List<String> photographs, String street,
            String zip, String state, String city, String district, int numberBedrooms, int numberParking,
            int numberBathrooms, String availableEquipment, boolean basement, boolean loft, SunExposure sunExposure)
            throws IllegalArgumentException {
        validateLocation(zip, street, state, city, district);
        validatePropertyArguments(propertyType, area, distance, photographs);
        validSunExposure(sunExposure);
     ...
     * @param sunExposure    direction from which the sun hits the house
     */
    public House(PropertyType propertyType, double area, double distance, String street,
            String zip, String state, String city, String district, int numberBedrooms, int numberParking,
            int numberBathrooms, String availableEquipment, boolean basement, boolean loft, SunExposure sunExposure)
            throws IllegalArgumentException {
        validateLocation(zip, street, state, city, district);
    ...
    public String getSunExposure() {
        return sunExposure.getSunExposure();
    }
    ...
    public boolean validPropertyType(PropertyType propertyType) {
         ...
         */
        return propertyType.getPropertyType().equals(PropertyType.HOUSE.getPropertyType()); // does this work?
        // return
        // propertyType.getPropertyType().equals(PropertyType.HOUSE.getPropertyType());
    }
    ...
    /**
     * Validates sun exposure by checking if it exists in the SunExposure enum
     * 
     * @return true or false
     */
    private void validSunExposure(SunExposure sunExposure) {
        SunExposure possibleTypes[] = SunExposure.values();
        boolean isExistingType = false;
        if (sunExposure == null)
            throw new IllegalArgumentException("Invalid sun exposure");
        for (SunExposure pt : possibleTypes) {
            if (sunExposure.getSunExposure().equals(pt.getSunExposure())) {
                isExistingType = true;
                break;
            }
        }
    ...
    public boolean equals(Object o) {
        ...
        if (this.getArea() != r.getArea())
            ...
            return false;
        else if (this.getLoft() != r.getLoft())
            return false;
        else if (this.getBasement() != r.getBasement())
            return false;
        else if (!(this.getSunExposure().equals(r.getSunExposure())))
            return false;
        else
            return true;
    }
