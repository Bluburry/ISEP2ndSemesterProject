...
public class SendEmailRespondBookingRequestDEI implements SendMessage {
    ...
    private static final String FILEA = "EmailRespondVisitRequestDEIAccepted.txt";
    private static final String FILER = "EmailRespondVisitRequestDEIRejected.txt";
